...
- Acceptable compact evidence starts at the original acceptable-candidate timestamp and advances only on fresh observations. All lighting constants remain in versioned `TrackingConfiguration.provisional` (`ios-provisional-v1`); calibration changes require a new profile and plan 11 evidence.
