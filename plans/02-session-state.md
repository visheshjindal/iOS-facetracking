...
4. Stop/invalidate before teardown on inactivity, Exit, access loss, failure or interruption. Clear face/histories/timers and ignore obsolete completions. Per the 2026-09-22 corrective decision, Retry and real geometry changes retain completed acquisition while clearing measurements; explicit loss Restart resets alignment. Issue stop before new start. Increment checked geometry revision for real viewport/transform changes.
