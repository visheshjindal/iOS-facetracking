...
6. Apply exact hint order: no face/target; horizontal; vertical; too large; too small; pose; hold/follow. Center tolerances are 0.10 times target dimensions, scales 0.65–0.95 inclusive. Oversized wins over undersized when axes disagree. Following movement directions refer to the mirrored viewport; alignment uses Center face.
